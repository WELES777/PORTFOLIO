...
<body>
    <div id="block-body">
        ...
        <div id="block-content">
            ...
            if (mysqli_num_rows($result1) > 0) {
                ...
                do {
                    ...
                    <div id="block-breadcrumbs-and-rating">
                        <p id="nav-breadcrumbs2"><a href="view_cat.php?type=switch">Switche</a> \ <span>' . $row1["model"] . '</span></p>
                    ...
                    <div id="block-content-info">
                        ...
                        <div id="block-mini-description">
                            ...
                            <p id="style-price" >' . group_numerals($row1["price"]) . ' zł</p>
            ...
            <ul class="tabs">
                <li><a class="active" href="#" >Opis</a></li>
                <li><a href="#" >Charakterystyki</a></li>
            ...
            <div class="tabs_content">
                ...
                <div>
                    <p id="link-send-review" ><a class="send-review" href="#send-review" >Napisać opinię</a></p>
                    ';
                    ...
                    if (mysqli_num_rows($query_reviews) > 0) {
                        ...
                        echo '<p class="title-no-info" >Brak opinii</p>';
                    }
            ...
            <div id="send-review" >
                ...
                <p align="right" id="title-review">Publikowanie opinii odbywa się po sprawdzeniu moderatora.</p>

                <ul>
                    <li><p align="right"><label id="label-name" >Imię<span>*</span></label><input maxlength="15" type="text"  id="name_review" /></p></li>
                    <li><p align="right"><label id="label-good" >Przewagi<span>*</span></label><textarea id="good_review" ></textarea></p></li>
                    <li><p align="right"><label id="label-bad" >Wady<span>*</span></label><textarea id="bad_review" ></textarea></p></li>
                    <li><p align="right"><label id="label-comment" >Komentarz</label><textarea id="comment_review" ></textarea></p></li>
                </ul>
