$(document).ready(function() {
    ...
    $('#button-pass-show-hide').click(function() {
        ...
        if (statuspass == "pass-show") {
            ...
            var $input = $("#auth_pass");
            var change = "text";
            var rep = $("<input placeholder='Hasło' type='" + change + "' />")
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data == 'yes') {
                        $(".auth-loading").hide();
                        $("#button-remind").show();
                        $('#message-remind').attr("class", "message-remind-success")
                            .html("Na twój email zostało odesłane hasło.").slideDown(400);
    ...
    $('#confirm-button-next').click(function(e) {
        ...
        if (!$(".order_delivery").is(":checked")) {
            ...
            } else { $("#order_name").css("borderColor", "#DBDBDB");
                send_order_name = '1'; }
            ...
            } else { $("#order_surname").css("borderColor", "#DBDBDB");
            ...
            if (isValidEmailAddress(order_email) == false) {
                ...
                send_order_email = '0';
            } else { $("#order_email").css("borderColor", "#DBDBDB");
                send_order_email = '1'; }
            ...
            if (order_phone == "" || order_phone.length > 50) {
                ...
                send_order_phone = '0';
            } else { $("#order_phone").css("borderColor", "#DBDBDB");
                send_order_phone = '1'; }
            ...
            } else { $("#order_address").css("borderColor", "#DBDBDB");
